...
expectEqual(
    qualified("http://tsx/path", domains: domains,
              hosts: [.init(shortName: "tsx", fullName: "tsx.example.ts.net.")]),
    "http://tsx.example.ts.net/path",
...
let records = [TailnetHostRecord(shortName: "tsx", fullName: "tsx.example.ts.net.")]
expectEqual(TailnetHostnameQualifier.isKnownFQDN("tsx.example.ts.net", hosts: records), true,
