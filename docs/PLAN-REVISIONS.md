...
**R43 — The app styles one row of the page, and remembers the gateways it has used** [bug report 2026-09-23; built 2026-09-25, `features/F5-portrait-session-list.md`]
