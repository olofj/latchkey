...
| [F6](F6-single-origin-web-view.md) | The web view loads the gateway, four named CDNs, and nothing else | **built** 2026-09-25 (R41); L1 38/38. **Session suite not run**: its pinned 0.6.0 bundle is gone from this Mac (§9). Two §4.1 claims did not hold on iOS 26 (§9) |
